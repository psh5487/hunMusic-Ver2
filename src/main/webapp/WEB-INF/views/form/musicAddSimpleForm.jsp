...
<div class="title">
	...
	<div style="width: 200px">
		<a class="nav-link" href="<%=request.getContextPath()%>/addMusicSimply"><h2 style="color: black">곡 간편 입력</h2></a>
	</div>
</div>

<div class="content">
<form name="music_form" method="POST" action="addMusicSimply" accept-charset="utf-8">
	<br><h5>바코드 넘버</h5>
	...
	<br>
	<img src="img/barcode.jpg" alt="바코드 입력 예시" style="width: 150px;">
