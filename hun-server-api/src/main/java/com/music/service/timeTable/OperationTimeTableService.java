package com.music.service.timeTable;

import com.music.model.timeTable.OperationTimeTable;
import com.music.model.timeTable.StudentTimeTable;
import com.music.repository.OperationTimeTableRepository;
import com.music.repository.StudentTimeTableRepository;
...
public class OperationTimeTableService {
    ...
    /* 운영 시간표 삭제 */
    public OperationTimeTable deleteOperationTable(Long id) {
